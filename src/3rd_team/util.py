...
def pipeline_test(test, bow_vectorizer, tfreq_vectorizer, tfidf_vectorizer):
    ...
    return headlines, body_ids, test_set
...
def save_predictions(headlines, body_ids, pred, file):
    ...
    with open(file, 'w') as csvfile:
        ...
        for i in range(len(pred)):
            writer.writerow({'Headline' : headlines[i], 'Body ID' : body_ids[i], 'Stance': label_ref_rev[pred[i]]})
