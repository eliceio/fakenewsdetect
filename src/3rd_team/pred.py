...
headlines, body_ids, test_set = pipeline_test(raw_test, bow_vectorizer, tfreq_vectorizer, tfidf_vectorizer)
...
# Save predictions
save_predictions(headlines, body_ids, test_pred, file_predictions)
